...
public class NewspaperTest {
    ...
    public void testCreateNewspaperWithValidData() {
        ...
        assertEquals(100, newspaper.getDiscountLimit());
    }
    ...
    public void testCreateNewspaperWithNegativeNumberOfPages() {
        try {
            ...
            assertEquals("The number of pages must not be negative.", e.getMessage());
        }
    }
    ...
    public void testCreateNewspaperWithNegativeUnitPrice() {
        try {
            ...
            assertEquals("Unit price must not be negative.", e.getMessage());
        }
    }
    ...
    public void testCreateNewspaperWithNegativeDiscountRate() {
        try {
            ...
            assertEquals("The discount rate must not be negative.", e.getMessage());
        }
    }

    @Test
    public void testCreateNewspaperWithNegativeDiscountLimit() {
        try {
            new Newspaper("News", 50, paper, 1.00, 0.90, -100);
            fail("Expected IllegalArgumentException for negative discount limit");
        } catch (IllegalArgumentException e) {
            assertEquals("The discount limit must not be negative.", e.getMessage());
        }
    }

    @Test
    public void testPrint() {
        Newspaper newspaper = new Newspaper("News", 50, paper, 1.00, 0.90, 100);
        newspaper.print();
    ...
    public void testCalculatePrintingCostsWithDiscount() {
        Newspaper newspaper = new Newspaper("News", 150, paper, 1.00, 0.90, 100);
