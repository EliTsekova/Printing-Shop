...
public class PrintingShopTest {
    ...
    public void testAddMachine() {
        ...
        assertEquals(2, shop.getMachines().size());
    ...
    public void testCalculateTotalSalaries() {
        ...
        assertEquals(1900, shop.calculateTotalSalaries());
    }
    ...
    public void testCalculateTotalExpenses() throws UnsupportedColorException {
        Manager manager = new Manager("Ivan", 1000, 10, 5000, 6000);
        shop.addEmployee(manager);
        Edition poster = new Poster("Poster", 10, standardPaper, 5.00);
        colorMachine.loadPaper(500);
        colorMachine.printEdition(poster, true);
        double expectedExpenses = 1100 + 10 * standardPaper.calculatePrice();
    ...
    public void testCalculateTotalIncome() throws UnsupportedColorException {
        ...
        double expectedIncome = 10 * 5.00 * 5;
        double actualIncome = shop.calculateTotalIncome();

        System.out.println("Expected Income: " + expectedIncome);
        System.out.println("Actual Income: " + actualIncome);
