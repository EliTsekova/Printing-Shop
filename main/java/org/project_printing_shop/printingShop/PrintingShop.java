...
import java.util.stream.Collectors;
 ...
 public class PrintingShop implements Comparable<PrintingShop> {
     ...
     private Map<PaperType, Double> paperPricing; // Pricing model per paper type
     private double totalSales; // Track total sales for comparison
     ...
     // Comparators for additional sorting options
     ...
     // Optional: toString method for easy debugging and display
     @Override
